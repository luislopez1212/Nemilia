...
6. **Run** — go to Compose, pick a workflow or write a prompt, and click **Run**
...
1. Go to the Nemilia listing on the [Chrome Web Store](https://chromewebstore.google.com/detail/nemilia-%E2%80%94-send-to-workspa/inkhagbajnhcnedmjhppgloeamfmhkfl) and click **Add to Chrome**
