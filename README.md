...
<img width="2816" height="1504" alt="full_logo" src="https://github.com/user-attachments/assets/3e26a433-1ff0-42c3-bc46-83790d2d6258" />
...
- **Web Search toggle** — click **Web Search** in the chat context bar to enable live web search on any message; button shows **Web Search ON** when active (requires a search provider configured in Connections)
...
| **WebGPU** | Llama 3.2 3B | Built-in (Chrome 121+) |
...
2. Look for the **Web Search** button in the context bar just above the message input.
